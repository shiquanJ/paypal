...
<script type="text/javascript" src="/js/cart/cart.js?v=1"></script>
...
<header id="orderHeader">
	<div class="orderHead">
		...
		<!-- <button type="button" class="btnType4" id="cartPayBtn" onclick="window.location.href='/';" style="float:right; margin-top:20px; border-radius:21px;">继续购买</button> -->
		</h1>
	</div>
</header>
<div id="container">
