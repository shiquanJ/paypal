...
<div style="height:200px;">
	<h2 class="orderTitle">下单成功~感谢您这次的消费~</h2>
		...
		<div class="orderWrap">
			<div id="cartArea" class="cartArea">
				<div class="cartList" id="chkWrap">
					<ul>
						<li>
							OrderID：<c:out value="${OrderID }"></c:out>
						</li>
						<li>
							paymentId：<c:out value="${PaymentId }"></c:out>
						</li>
						<li>
							PayerID：<c:out value="${PayerID }"></c:out>
						</li>
					</ul>
				</div>
				<button type="button" class="btnType4" id="cartPayBtn" onclick="window.location.href='/';" style="margin-top:30px;">继续购买</button>
			</div>
		</div>
	</div>
</div>
